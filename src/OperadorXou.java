...
public class OperadorXou {
	...
	public static void main(String[] args) {
		 ...
		 * Escreva o código de um programa que receba a umidade relativa do ar e 
		 *a temperatura atual. Caso a umidade seja maior que 70% ou caso o
		 * temperatura seja maior que 26°C, exibir a mensagem "ligando os ventiladores".
		 *  Caso as duas condições sejam verdadeiras ou falsas, exibir a mensagem: "Entrar em contato com agrônomo".*/
